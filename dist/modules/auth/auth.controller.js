...
let AuthController = class AuthController {
    ...
    async login(response, credential) {
    ...
    async register(response, userRegistration) {
    ...
    async getUserById(response, req) {
        return response.status(common_1.HttpStatus.OK).json({
            "status": "success",
            "message": "successful operation",
            "data": req.user
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, credential_dto_1.CredentialDTO]),
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, user_registration_dto_1.UserRegistrationlDTO]),
    __metadata("design:returntype", Promise)
